...
const SEED_PRODUCTS: SeedProduct[] = [
    ...
    { productId: "p-1003", name: "Mechanical Keyboard (Blue Switch)", description: "คีย์บอร์ดแมคคานิคอลสัมผัส เพลิดเพลิน พิมพ์สนุก", price: 1290.0, availableStock: 500, isFlashSaleActive: false },
...
export class SeedProducts1787802529400 implements MigrationInterface {
    name = 'SeedProducts1787802529400'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        const ids = SEED_PRODUCTS.map((p) => p.productId);
        await queryRunner.query(`DELETE FROM "products" WHERE "productId" = ANY($1)`, [ids]);
    }
}
